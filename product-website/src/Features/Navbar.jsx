  ...
  return (
    <header className='p-3 bg-[#f2f2f2] shadow-md  fixed top-0 w-full z-[999]'>
        <nav className='flex items-center justify-between px-4'>
            ...
            <span className='bg-white p-2' ><HiOutlineEnvelope/></span>
            <span className='bg-white p-2' ><HiOutlineMagnifyingGlass /></span>
            <span className='bg-white p-2 flex items-center gap-2 text-[0.8rem]' ><FaRegUser /> Daniel</span>
            </div>
        </nav>
    </header>
  );
