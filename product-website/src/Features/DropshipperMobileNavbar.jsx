...
function DropshipperMobileNavbar({ store, isOpen, page, toggleMenu }) {
  ...
  return (
    <div className="flex items-center !justify-between md:px-5">
      ...
      <div className={`absolute top-[4.8rem] left-0 w-64 h-screen bg-white transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform ease-in-out duration-300 z-[999]`}>
        <ul className="flex flex-col gap-y-6 bg-white py-4 px-5 border-r-2 border-r-gray-300">
          <li className="uppercase tracking-[1px] mt-10">
            <div onClick={() => toggleDropdown("products")} >
             ...
             <span className="flex items-center gap-x-2"><FaHome/> Products</span>
             <span> {dropdowns.products ? <FaAngleUp className="text-[22px]" /> : <FaMinus/> } </span>
          ...
          <li className="uppercase tracking-[1px]">
            ...
            <div className="flex items-center justify-between">
             <span className="flex items-center gap-x-2"><MdOutlineSpaceDashboard /> Dashboard</span>
             <span> {dropdowns.products ? <FaAngleUp className="text-[22px]" /> : <FaMinus/> } </span>
          ...
          <li className="uppercase tracking-[1px]">
            <div onClick={() => toggleDropdown("marketplace")}>
              ...
              <div className="flex items-center justify-between">
             <span className="flex items-center gap-x-2">< Marketplace />  Marketplace</span>
             <span> {dropdowns.products ? <FaAngleUp className="text-[22px]" /> : <FaMinus/> } </span>
      ...
      <div className="">
        {store.logo ? (
          <img src={store?.logo} alt="logo" width={50} height={50} className="" />
        ) : (
      ...
      <div className="relative flex items-center justify-between gap-3">
        <span className="relative p-2 z-0 text-[1.2rem] cursor-pointer" onClick={() => navigate("/cart")}>
