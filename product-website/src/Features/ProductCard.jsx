...
export default function ProductCard({ id, image, price, name }) {
    ...
    return (
      <div key={id} className='relative bg-white rounded-lg overflow-hidden hover:shadow-md h-auto w-full transition-all duration-500 max-w-sm  product-card mb-5'>
        ...
        <div className='hover:scale-[1.08] hover:transition-all duration-300 ease-in-out'>
          ...
          <div className='bg-[var(--product-bg)] p-4'>
            ...
            <button className='text-black bg-[#ffa500] px-3 h-6 whitespace-nowrap add-to-cart-button text-[0.8rem] mt-2 mb-2'>Add to cart</button>
          </div>
        </div>
      </div>
    );
