...
export default function PersonalDataUpdate({
  updateData,
  storeUser,
  handleProfileUpdate,
  setUpdateData,
}) {
  const url = `https://rocktea-mall-api-test.up.railway.app/rocktea/storeowner/${storeUser?.id}/`;
  const { image, fileInputRef, handleFileChange, openFileInput } =
    useImageUpload(storeUser?.profile_image, "profile_image", url);
      ...
      >
        <div className="relative">
          <img
            ...
            src={image || storeUser?.profile_image}
            alt="profile image"
          />
