    ...
    datasets: [
      {
        ...
        borderRadius: 6,
        //barPercentage: 0.9, // Adjust this to control the width of the bars
      },
      {
        label: 'Earned',
  ...
  return (
    <section className="bg-white mt-5 lg:w-[65%] h-full px-5 py-5 shadow-lg rounded-xl ml-3">
        ...
        <div className='flex justify-between px-5'>
            <div>
        <h2 className="text-lg font-bold mb-4">General Sales Activity</h2>
        <p className='text-gray-500'>Sales generated</p>
        <div className="flex items-center gap-x-3 mt-1">
<h3 className="font-bold  text-[1.5rem]">N500,000 </h3>
<p className="text-[0.7rem] bg-[#00ae0080] shadow-percentShadow border border-solid rounded-[20px] p-1 px-2 text-white">34%</p>
</div>
    </div>
    <div>
    <div className="bg-gray-300 rounded-lg w-auto h-[50px] flex items-center gap-3 px-5">
          <span className='border-r-[1.5px] border-r-gray-400 px-2'>Weekly</span>
          <span className='border-r-[1.5px] border-r-gray-400 px-2'>Monthly</span>
          <span>Yearly</span>
        </div>
