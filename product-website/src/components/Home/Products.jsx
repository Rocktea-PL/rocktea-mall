...
let sunlight =
  "https://res.cloudinary.com/dwvdgmuaq/image/upload/v1694422696/rocktea-product-website/assets/Pepsi_ygfvm6.png";
let Malt =
  ...
  return (
    <section className=" mt-5 pt-2 pb-5 mx-5 md:mx-12 rounded-lg flex flex-col items-center justify-center mb-10 overflow-x-hidden">
      <div className="relative w-full">
        ...
        <span
          className="absolute top-3 right-5 text-right flex items-center gap-2 text-[var(--orange)] cursor-pointer"
          onClick={() => alert("yesss")}
        >
        ...
        <button className="flex items-center justify-center gap-2 bg-white p-3 rounded-lg my-7">
          Load more
        </button>
      </div>
      <div className="relative w-full">
        <h2 className="text-center font-semibold mt-5 text-2xl">
          Limited Stock deals
        </h2>
        <span className="absolute top-5 right-5 text-right flex items-center gap-2 text-[var(--orange)]">
          See All <FaAngleRight />
        </span>
