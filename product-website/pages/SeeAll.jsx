...
Data()
   ...
   const filteredProducts = allProducts?.length > 0 &&  allProducts.filter((item) => item.product.subcategory == categoryName);
...
<h3 className=" whitespace-nowrap text-blue font-bold text-center text-[22px] capitalize"> &quot;{categoryName}&quot; </h3>
        <span className="lg:absolute right-5 top-6  text-[18px]">{filteredProducts?.length} products found</span>
</div>
