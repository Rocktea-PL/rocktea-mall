  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-center w-full gap-5">
      ...
      <div className=" md:w-3/4 flex justify-between bg-white rounded-md  p-3 h-[150px]">
        ...
        <div className="p-2">
            <button className=" block bg-[var(--orange)] p-3 rounded-lg">Delete</button>
          </div>
      ...
      <div className="md:w-1/4 mb-10 ">
        <div className="bg-white p-4 w-full h-auto shadow rounded-md py-5 px-7">
          ...
          />
          <button className='block bg-[var(--orange)] p-2 px-4 rounded-md '>Enter</button>
          </div>
...
<Link to='/checkout'>
   <button className='flex items-center justify-center mx-auto my-10 bg-[var(--orange)] rounded-md w-full h-12'>Checkout</button>
   </Link>    
