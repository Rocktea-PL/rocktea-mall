...
function Checkout() {
    ...
    return (
       <section className="px-5 mx-5">
            ...
            <div className='flex items-center gap-1 mb-4'>
                <p className='flex items-center'>Home<FaAngleRight /></p>
               <p className='flex items-center'>Products<FaAngleRight /></p>
                <p className='flex items-center'>Groceries<FaAngleRight /></p>
                <p className='flex items-center'>Pepsi<FaAngleRight /></p>
                <p className='flex items-center'>Cart<FaAngleRight /></p>
                <p className='flex items-center'>Checkout<FaAngleRight /></p>
        ...
        <article className="flex justify-between gap-x-16">
           <div className="w-1/2">
            ...
            <form action="" className="checkout-form grid grid-cols-2 gap-3 my-10">
                <input type="text" />
                <input type="text" />
            ...
            <p className="text-sm text-red-500">We do not accept payment on delivery </p>
            <form action="" className="mb-3">
                <div className="checkout-form grid grid-cols-2 gap-3 my-10">
                <label htmlFor="cardNumber" className="col-span-2">  Card Number
                <input type="text" 
                id="cardNumber"
  ...
  <h3 className='flex items-start justify-between  text-center'>
    ...
    <span className='font-semibold flex-1 text-right mr-3'>₦12,300</span>
  </h3>
  <h3 className='flex items-start justify-between  '>
    <span className=''>Delivery Cost</span>
    <span className='font-semibold flex-1 text-right mr-3'>₦120</span>
  </h3>
  <h3 className='flex items-start justify-between '>
    <span className=''>Discount</span>
    <span className='font-semibold block flex-1 text-right mr-3'>₦12</span>
  </h3>
  ...
  <h3 className='flex items-center justify-between '> 
    ...
    <span className='font-semibold'>₦12,500</span>
        ...
        <Link to='/checkout'>
            ...
            <button className='flex items-center justify-center mx-auto my-5 bg-[var(--orange)] rounded-md w-full h-12'>Checkout</button>
