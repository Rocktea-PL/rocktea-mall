...
import FileInput from "../../src/Public/Components/Forms/SignUp/FormImage";
//import { NavLink } from "react-router-dom";
import { ImageWithLoading } from "../../src/Public/Components/ImageLoader";
//import EmailVerification from "../../src/Public/Components/Forms/SignUp/EmailVerification";
  ...
  return (
    <>
        ...
        <div className=" flex items-center justify-center lg:justify-start lg:h-screen lg:overflow-hidden">
          ...
          <div className= {`${isCheckerOpen && 'lg:pt-[11rem] overflow-auto'} max-w-[85%] lg:w-[450px] mx-auto flex flex-col items-center justify-center py-8 transition-all  px-5  h-full`}>
