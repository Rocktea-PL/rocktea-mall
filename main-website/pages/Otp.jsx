  ...
  formData.append("store_owner", owner);
    ...
    return (
        ...
        <figure className="flex items-center justify-center mt-2  mb-6">
         ...
         <p className="text-center">Make a one time payment of 
N5000 that will be used to host
your store URL.</p>
<button onClick={handlePaymentInitiation} className="flex items-center justify-center bg-[var(--yellow)] py-3 px-5 rounded-lg">Procceed to payment</button>
