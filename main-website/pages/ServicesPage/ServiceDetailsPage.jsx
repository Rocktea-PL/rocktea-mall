...
and global glamour.`}{" "}
            ...
            <h4>
              Address <br />{" "}
              {servicesDetail?.location ||
                "135b Ismaila saka Close, princeston estate, Lekki."}
            </h4>
            <button
      ...
      {isReportModal && (
        <ReportUserModal
          userId={servicesDetail?.user}
          closeModal={() => setIsReportModal(false)}
        />
      )}
    </>
  );
