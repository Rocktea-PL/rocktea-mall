...
function Faqs() {
  return (
    <div className="bg-[#F9F9F8;] relative h-full">
      ...
      <div >
        <h3 className="absolute top-[20%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-[20px] sm:text-[30px] lg:text-[40px] whitespace-nowrap">Frequently Asked Questions</h3>
        <p className="absolute top-[26%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-sm sm:text-[20px]">How may i help you?</p>
      </div>
