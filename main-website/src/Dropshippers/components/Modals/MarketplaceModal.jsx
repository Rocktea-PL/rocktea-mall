      ...
      <div className="pt-8 bg-white rounded-lg relative w-[70%]  lg:w-[500px] flex flex-col   ">
        ...
        <article className="flex flex-col gap-y-3 leading-[1] items-start mt-10 mb-10 h-auto">
          ...
          <div className="flex items-center mx-auto justify-center mt-7 gap-5">
            <button className="bg-orange h-12 w-[150px] rounded-lg" onClick={handleAddPrice}>
              Add Product
            </button>
          ...
          {addPrice && (
            ...
            <h4 className="text-center text-[20px] text-blue font-semibold">Add Price</h4>
          <form action="" className="px-5 flex items-center justify-center mx-auto gap-3 mt-5">

              <input type="text" className="border bg-white shadow-md border-gray-200 h-10 rounded" />
              <button className="p-2 px-4 rounded-md bg-orange">Go</button>
            </form>
            </div>
          )}
        </article>
