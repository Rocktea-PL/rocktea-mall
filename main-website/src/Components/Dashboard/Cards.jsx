...
export default function ServiceCards() {
  ...
  return (
    <article className="my-5">
      <div className="relative bg-white shadow-md p-3 w-[350px] h-[200px] rounded-xl overflow-x-hidden">
        <h4 className="text-md">Earnings</h4>
        <h3 className="mt-5">N50,000</h3>
        <p>+33%</p>
        <img
          src={Cube}
          width={100}
