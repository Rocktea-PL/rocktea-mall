    ...
    datasets: [
      {
        label: "Withdrawn",
        data: [
          3000, 2000, 2000, 1000, 5000, 3000, 3000, 2000, 2000, 1000, 5000,
          3000,
        ], // Example data for withdrawn
      ...
      },
      {
        label: "Earned",
        data: [
          1000, 3000, 2000, 2000, 5000, 4000, 1000, 3000, 2000, 2000, 5000,
          4000,
        ], // Example data for earned
