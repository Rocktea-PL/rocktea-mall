...
function Login() {
  ...
  return (
    <div className="relative lg:h-screen w-full  flex flex-col lg:flex-row items-center justify-center lg:justify-start lg:gap-10  lg:overflow-hidden mb-10">
      <div className="hidden lg:max-w-[45%] w-full  lg:flex lg:h-screen  ">
        <ImageWithLoading
